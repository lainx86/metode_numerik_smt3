...
title(['Skenario 1: Konsentrasi Polutan terhadap Ruang (G=', num2str(G), ')'], ["Feby Syarief A-0087-Ose C"]);
xlabel('Jarak (meter)');
...
title(['Skenario 1: Konsentrasi Polutan terhadap Waktu'], ["Feby Syarief A-0087-Ose C"]);
xlabel('Waktu (detik)');
ylabel('Konsentrasi (mg/l)');
